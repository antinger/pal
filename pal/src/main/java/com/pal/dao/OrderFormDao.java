...
public interface OrderFormDao {
    ...
    String INSERT_FIELDS = " card, userName, toUserName, content, price, createDate, doneDate ";
    String SELECT_FIELDS = " id, " + INSERT_FIELDS;
    
    //添加记录
    @Insert({"insert into ", TABLE_NAME, "(", INSERT_FIELDS, ") values (#{card},#{userName},#{toUserName},#{content},#{price},#{createDate},#{doneDate})"})
