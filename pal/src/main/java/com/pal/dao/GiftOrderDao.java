...
public interface GiftOrderDao {
    ...
    String INSERT_FIELDS = " giftID, num, price, username, toUsername, lineID, createDate, content, status ";
    String SELECT_FIELDS = " id, " + INSERT_FIELDS;
    
    //添加礼物
    @Insert({"insert into ", TABLE_NAME, "(", INSERT_FIELDS, ") values (#{giftID},#{num},#{price},#{username},#{toUsername},#{lineID},#{createDate},#{content}, #{status})"})
